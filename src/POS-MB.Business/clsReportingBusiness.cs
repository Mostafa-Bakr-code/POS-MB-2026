...
public class clsReportingBusiness(clsReportingDataAccess dataAccess)
{
    ...
    public Task<IEnumerable<ItemSalesRow>> GetItemSalesAsync(DateTime? startDate = null, DateTime? endDate = null, bool groupByDay = false) =>
        dataAccess.GetItemSalesAsync(startDate, endDate, groupByDay);
