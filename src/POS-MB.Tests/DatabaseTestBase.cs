...
public abstract class DatabaseTestBase : IDisposable
{
    ...
    protected DatabaseTestBase()
    {
        ...
        OrderBusiness = new clsOrderBusiness(new clsOrderDataAccess(ConnectionFactory), SettingsBusiness, paymobClient, NullLogger<clsOrderBusiness>.Instance, StudentBusiness);
